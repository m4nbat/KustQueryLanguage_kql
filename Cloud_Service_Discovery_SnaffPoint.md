# Cloud Service Discovery via SnaffPoint - Suspicious SharePoint Search Activity
...
| ---  | --- | --- |
| T1526 | Cloud Service Discovery | [Cloud Service Discovery](https://attack.mitre.org/techniques/T1526/) |
| T1213.002 | Data from Information Repositories: SharePoint | [SharePoint](https://attack.mitre.org/techniques/T1213/002/) |

#### Description
Detects suspicious search activity on SharePoint that may indicate use of discovery/enumeration tools like SnaffPoint. Looks for searches containing sensitive keywords such as passwords, credentials, SSH keys, and connection strings.

#### Risk
SnaffPoint and similar tools are used by adversaries post-compromise to enumerate SharePoint for sensitive data. This activity often follows initial access and precedes data exfiltration.
