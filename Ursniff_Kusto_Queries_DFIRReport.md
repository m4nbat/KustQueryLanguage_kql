# Ursnif Banking Trojan Detection Queries
...
#### Description
Detection queries for Ursnif (Gozi) banking trojan post-compromise activity. Covers driverquery discovery, mshta registry execution, nslookup recon, system time lookup, LOLBIN from non-C drives, and Impacket lateral movement.

#### Risk
Ursnif (Gozi) is a banking trojan that uses process injection, credential theft, and lateral movement. DFIR Report documented its 2023 TTPs.
