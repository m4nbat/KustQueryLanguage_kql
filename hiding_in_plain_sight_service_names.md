# Malicious Service Name Masquerading (svchost typosquatting) Detection
...
| ---  | --- | --- |
| T1036.004 | Masquerading: Masquerade Task or Service | [Masquerade Task or Service](https://attack.mitre.org/techniques/T1036/004/) |

#### Description
Detects malicious processes using typosquatted or slightly modified versions of svchost.exe filenames to evade detection. Uses a comprehensive list of known malicious service names.

#### Risk
Adversaries rename malware executables to mimic legitimate Windows service host names (svchost.exe variants) to evade detection and blend in with normal system activity.
