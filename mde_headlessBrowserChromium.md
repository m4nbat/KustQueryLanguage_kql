...
#### Risk
Threat actors abuse headless Chromium-based browsers to silently download malicious payloads while evading detection. The Ducktail infostealer and similar malware families leverage this technique to fetch second-stage payloads or exfiltrate data without spawning a visible browser window.
...
#### References
- [Red Canary Intelligence Insights June 2023](https://redcanary.com/blog/intelligence-insights-june-2023/)
