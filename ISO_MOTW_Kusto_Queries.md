# ISO File and Mark of the Web (MOTW) Bypass Detection
...
#### Description
Detects ISO/VHD/VHDX file-related activity used to bypass Mark of the Web (MOTW) security controls. Identifies ISO mount events, recent file entries for image files, and browser-initiated downloads of container files.

#### Risk
Adversaries use ISO/VHD files to bypass MOTW protections that would normally trigger security warnings. This technique was widely adopted by threat actors including Qakbot and Emotet after macro-based attacks were restricted.
